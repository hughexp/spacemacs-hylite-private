...
;; command-log-mode is a mode that Show event history and command history of some or all buffers. It lets you show keys and commands you use in emacs in real time.
;; git address is : https://github.com/lewang/command-log-mode
;; 
