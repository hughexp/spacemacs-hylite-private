;;; packages.el --- hylite-ui layer packages file for Spacemacs.
;;
...
;; added to `hylite-ui-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `hylite-ui/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `hylite-ui/pre-init-PACKAGE' and/or
;;   `hylite-ui/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst hylite-ui-packages
  '(
...
(defun hylite-ui/init-zilong-mode-line ()
  (defun hylite/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (hylite/display-mode-indent-width))
                 ;; line and column
...
(defun hylite-ui/post-init-diminish ()
  (progn
...
(defun hylite-ui/post-init-spaceline ()
...
(defun hylite-ui/init-evil-vimish-fold ()
...
(defun hylite-ui/post-init-hl-anything ()
  (progn
...
(defun hylite-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun hylite-ui/post-init-popwin ()
  (progn
    (push "*hylite/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun hylite-ui/post-init-whitespace ()
  (progn
