...
(defun hylite-note/init-blog-admin ()
...
(defun hylite-note/post-init-org-pomodoro ()
  (progn
    (add-hook 'org-pomodoro-finished-hook '(lambda () (hylite/growl-notification "Pomodoro Finished" "☕️ Have a break!" t)))
    (add-hook 'org-pomodoro-short-break-finished-hook '(lambda () (hylite/growl-notification "Short Break" "🐝 Ready to Go?" t)))
    (add-hook 'org-pomodoro-long-break-finished-hook '(lambda () (hylite/growl-notification "Long Break" " 💪 Ready to Go?" t)))
    ))

;;In order to export pdf to support Chinese, I should install Latex at here: https://www.tug.org/mactex/
;; http://freizl.github.io/posts/2012-04-06-export-orgmode-file-in-Chinese.html
;;http://stackoverflow.com/questions/21005885/export-org-mode-code-block-and-result-with-different-styles
(defun hylite-note/post-init-org ()
...
;;        )
      ...
      (setq org-capture-templates
            '(("t" "Todo" entry (file+headline org-agenda-file-gtd "Workspace")
              ...
              ("c" "Chrome" entry (file+headline org-agenda-file-note "Quick notes")
               "* TODO [#C] %?\n %(hylite/retrieve-chrome-current-tab-url)\n %i\n %U"
               :empty-lines 1)
      ...
      (setq org-agenda-custom-commands
            '(
              ...
              ("pl" tags-todo "PROJECT+DREAM+CATEGORY=\"hylite\"")
              ("W" "Weekly Review"
               ((stuck "") ;; review stuck projects as designated by org-stuck-projects
                (tags-todo "PROJECT") ;; review all projects (assuming you use todo keywords to designate projects)
                ))))

      (defvar hylite-website-html-preamble
        "<div class='nav'>
<ul>
<li><a href='http://hylite.com'>博客</a></li>
<li><a href='/index.html'>Wiki目录</a></li>
</ul>
</div>")
      (defvar hylite-website-html-blog-head
      ...
      (setq org-publish-project-alist
            `(
              ("blog-notes"
               ...
               :recursive t
               :html-head , hylite-website-html-blog-head
               ...
               :section-numbers nil
               :html-preamble ,hylite-website-html-preamble
               :author "hylite"
          ...
          (let* ((numberedp (org-export-numbered-headline-p headline info))
                 ...
                 (extra-ids
                  (mapconcat
                   (lambda (id)
                     (org-html--anchor
                      (if (org-uuidgen-p id) (concat "ID-" id) id)XS
                      nil nil info))
                   (cdr ids) "")))
...
(defun hylote-note/init-org-tree-slide ()
  (use-package org-tree-slide
    :init
    (spacemacs/set-leader-keys "oto" 'org-tree-slide-mode)))


(defun hylite-note/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun hylite-note/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/org-notes")))

(defun hylite-note/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun hylite-note/post-init-deft ()
  (progn
