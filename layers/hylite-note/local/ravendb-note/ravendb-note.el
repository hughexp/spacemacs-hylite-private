;; This is a packages used to save notes to ravendb.
;; We use http to contact with ravendb.
;; So ,first,you need to install ravendb,and then use this client to save to or search from ravendb.
;; Good lunck.
