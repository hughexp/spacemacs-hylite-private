;;; config.el --- hylite Layer packages File for Spacemacs
;;
...
;;条状显示当前位置并闪烁,这个地方需要放到init的user-config中去设置，否则是没有效果的；下面的第三个设置是有效的
;;(setq-default evil-emacs-state-cursor '("chartreuse3" (bar . 2)))
;;(setq-default cursor-type 'bar)
(setq-default evil-emacs-state-cursor '("green" bar))
